...
| --- | --- |
| **Total de regras** | 511 |
| **Público** | QA / produto — apenas comportamento visível na tela |
| **Planilha** | [`regras-negocio-qa.csv`](./regras-negocio-qa.csv) |
| **Inventário por tela** | [`telas/`](./telas/) |

---

## Índice alfabético por ID
