    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-muted/30 rounded-xl p-6 space-y-4">
          ...
          <Link href="/contato?assunto=Reportar+Bug" className="inline-block bg-primary text-primary-foreground font-medium px-6 py-3 rounded-lg hover:bg-primary/90 transition-colors">
